...
import ru.sadikov.dz.magafondz.Services.RegistrationService;
import ru.sadikov.dz.magafondz.Util.UsersValidator;
...
@Autowired
    ...
    public String performRegistration(@ModelAttribute("users") @Valid Users users, Role role,
        ...
        registrationService.register(users,role);
